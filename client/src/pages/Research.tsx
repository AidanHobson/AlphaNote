...
const OUTLOOK_PILLS = ['Lithography', 'Memory', 'China Tech', 'China Robotics', 'China Memory', 'Photonics', 'Robotics', 'Energy', 'AI Picks & Shovels', 'AI Bottlenecks', 'Quantum Computing', 'Space', 'Defense Tech', 'GLP-1'];
